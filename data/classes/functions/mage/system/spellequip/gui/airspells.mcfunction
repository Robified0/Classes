...
#Levitate
item replace entity @s[advancements={classes:mage/learnspell/air/levitate=true}] inventory.0 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Levitate","color":"yellow"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 2","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Air","color":"yellow"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Lifts enemies into the air,","color":"yellow"}','{"text":" and drops them.","color":"yellow"}','{"text":" "}','[{"text":""},{"text":"Self Cast:"}]','{"text":"Cast at the ground to lift","color":"yellow"}','{"text":" yourself up in the air.","color":"yellow"}','{"text":" Gives brief slow fall.","color":"yellow"}']},CustomModelData:60400,cl.s.Spell:1b,cl.s.Air:1b,cl.s.Levitate:1b,cl.spell.number:400}
execute if entity @s[advancements={classes:mage/learnspell/air/levitate=false}] run item replace entity @s inventory.0 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/air/levitate] run item replace entity @s inventory.0 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Slowfall
item replace entity @s[advancements={classes:mage/learnspell/air/slowfall=true}] inventory.1 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Slow Fall","color":"yellow"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 2","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Air","color":"yellow"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Grants caster and allies within 5 blocks Slow Fall for 10 seconds.","color":"yellow"}']},CustomModelData:60401,cl.s.Spell:1b,cl.s.Air:1b,cl.s.Slowfall:1b,cl.spell.number:401}
execute if entity @s[advancements={classes:mage/learnspell/air/slowfall=false}] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/air/slowfall] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Tail Wind
item replace entity @s[advancements={classes:mage/learnspell/air/tailwind=true}] inventory.2 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Tail Wind","color":"yellow"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 2","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Air","color":"yellow"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Grants you 10% more speed to run away for 10 seconds.","color":"yellow"}']},CustomModelData:60402,cl.s.Spell:1b,cl.s.Air:1b,cl.s.TailWind:1b,cl.spell.number:402}
execute if entity @s[advancements={classes:mage/learnspell/air/tailwind=false}] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/air/tailwind] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
