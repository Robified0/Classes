...
#Levitate
item replace entity @s[advancements={classes:mage/learnspell/air/levitate=true}] inventory.0 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Levitate","color":"yellow"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 1","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Air","color":"yellow"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Lifts enemies into the air,","color":"gold"}','{"text":" and drops them.","color":"gold"}','{"text":" "}','[{"text":""},{"text":"Self Cast:"}]','{"text":"Cast at the ground to lift","color":"gold"}','{"text":" yourself up in the air.","color":"gold"}','{"text":" Gives brief slow fall.","color":"gold"}']},CustomModelData:60400,cl.s.Spell:1b,cl.s.Air:1b,cl.s.Levitate:1b,cl.spell.number:400}
execute if entity @s[advancements={classes:mage/learnspell/air/levitate=false}] run item replace entity @s inventory.0 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/air/levitate] run item replace entity @s inventory.0 with minecraft:air
...
execute if entity @s[advancements={classes:mage/learnspell/air/slowfall=false}] run item replace entity @s inventory.1 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/air/slowfall] run item replace entity @s inventory.1 with minecraft:air
...
execute if entity @s[advancements={classes:mage/learnspell/air/tailwind=false}] run item replace entity @s inventory.2 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/air/tailwind] run item replace entity @s inventory.2 with minecraft:air
...
execute if entity @s[advancements={classes:mage/learnspell/air/bunnyhop=false}] run item replace entity @s inventory.3 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/air/bunnyhop] run item replace entity @s inventory.3 with minecraft:air
