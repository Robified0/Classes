...
execute if entity @s[advancements={classes:mage/learnspell/fire/torch=false}] run item replace entity @s inventory.0 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/fire/torch] run item replace entity @s inventory.0 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Fireball
item replace entity @s[advancements={classes:mage/learnspell/fire/fireball=true}] inventory.1 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Fireball","color":"dark_red"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 4","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Fire","color":"red"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Summons a Fireball to deal heavy damage and knockback enemies where it lands.","color":"red"}']},CustomModelData:60203,cl.s.Spell:1b,cl.s.Fire:1b,cl.s.Fireball:1b,cl.spell.number:203}
execute if entity @s[advancements={classes:mage/learnspell/fire/fireball=false}] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/fire/fireball] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Fire Shield
item replace entity @s[advancements={classes:mage/learnspell/fire/fireshield=true}] inventory.2 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Fire Shield","color":"dark_red"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 2","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Fire","color":"red"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Grants fire resistance for 5 seconds, and ignites mobs around you.","color":"red"}']},CustomModelData:60204,cl.s.Spell:1b,cl.s.Fire:1b,cl.s.FireShield:1b,cl.spell.number:204}
execute if entity @s[advancements={classes:mage/learnspell/fire/fireshield=false}] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/fire/fireshield] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Bed of Coals
item replace entity @s[advancements={classes:mage/learnspell/fire/bedofcoals=true}] inventory.3 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Bed of Coals","color":"dark_red"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 3","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Fire","color":"red"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"A fiery bed of flames appears under you, damaging enemies that walk on it.","color":"red"}','{"text":" "}]']},CustomModelData:60201,cl.s.Spell:1b,cl.s.Fire:1b,cl.s.BedOfCoals:1b,cl.spell.number:201}
execute if entity @s[advancements={classes:mage/learnspell/fire/bedofcoals=false}] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/fire/bedofcoals] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Flame Burst
item replace entity @s[advancements={classes:mage/learnspell/fire/flameburst=true}] inventory.4 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Flame Burst","color":"dark_red"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 3","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Fire","color":"red"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Scorch enemies within 6 blocks of you.","color":"red"}']},CustomModelData:60202,cl.s.Spell:1b,cl.s.Fire:1b,cl.s.FlameBurst:1b,cl.spell.number:202}
execute if entity @s[advancements={classes:mage/learnspell/fire/flameburst=false}] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/fire/flameburst] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
