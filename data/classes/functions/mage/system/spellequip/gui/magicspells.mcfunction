...
execute if entity @s[advancements={classes:mage/learnspell/magic/magicmissile=false}] run item replace entity @s inventory.0 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/magicmissile] run item replace entity @s inventory.0 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:mage/learnspell/magic/magearmor=false}] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/magearmor] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:mage/learnspell/magic/light=false}] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/light] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:mage/learnspell/magic/teleport=false}] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/teleport] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:mage/learnspell/magic/shield=false}] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/shield] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:mage/learnspell/magic/invisibility=false}] run item replace entity @s inventory.5 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/invisibility] run item replace entity @s inventory.5 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:mage/learnspell/magic/mend=false}] run item replace entity @s inventory.6 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/mend] run item replace entity @s inventory.6 with minecraft:black_stained_glass_pane{cl.item.noDrop:1b}
