...
#Teleport
item replace entity @s[advancements={classes:mage/learnspell/magic/teleport=true}] inventory.2 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Teleport","color":"light_purple"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 1","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Magic","color":"light_purple"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Teleport to the targeted location - must hit a block.","color":"light_purple"}']},CustomModelData:60601,cl.s.Spell:1b,cl.s.Magic:1b,cl.s.Teleport:1b,cl.spell.number:601}
execute if entity @s[advancements={classes:mage/learnspell/magic/teleport=false}] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/teleport] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Shield
item replace entity @s[advancements={classes:mage/learnspell/magic/shield=true}] inventory.3 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Shield","color":"light_purple"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003/1 Sec","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Magic","color":"light_purple"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Reflects projectiles coming at the direction the caster is facing.","color":"light_purple"}']},CustomModelData:60602,cl.s.Spell:1b,cl.s.Magic:1b,cl.s.Shield:1b,cl.spell.number:602}
execute if entity @s[advancements={classes:mage/learnspell/magic/shield=false}] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/shield] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Invisibility
item replace entity @s[advancements={classes:mage/learnspell/magic/invisibility=true}] inventory.4 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Invisibility","color":"light_purple"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 1","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Magic","color":"light_purple"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Grants the caster invisibility for 20 seconds.","color":"light_purple"}']},CustomModelData:60603,cl.s.Spell:1b,cl.s.Magic:1b,cl.s.Invisibility:1b,cl.spell.number:603}
execute if entity @s[advancements={classes:mage/learnspell/magic/invisibility=false}] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/invisibility] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Mend
item replace entity @s[advancements={classes:mage/learnspell/magic/mend=true}] inventory.5 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Mend","color":"light_purple"},{"text":" - ","color":"white","bold":false},{"text":"\\uE004 x 1","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','[{"text":"Element: ","color":"dark_aqua"},{"text":"Magic","color":"light_purple"}]','{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Heals caster for two hearts over 5 seconds.","color":"light_purple"}']},CustomModelData:60604,cl.s.Spell:1b,cl.s.Magic:1b,cl.s.Mend:1b,cl.spell.number:604}
execute if entity @s[advancements={classes:mage/learnspell/magic/mend=false}] run item replace entity @s inventory.5 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/mage/magic/mend] run item replace entity @s inventory.5 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
