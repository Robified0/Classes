...
execute as @s[scores={cl.wand.slot4=203}] run function classes:mage/spells/fire/fireball/select
...
execute as @s[scores={cl.wand.slot4=404}] run function classes:mage/spells/air/wind/select
...
execute as @s[scores={cl.wand.slot4=505}] run function classes:mage/spells/earth/wall/select
