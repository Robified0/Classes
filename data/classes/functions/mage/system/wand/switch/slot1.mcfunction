...
execute as @s[scores={cl.wand.slot1=203}] run function classes:mage/spells/fire/fireball/select
...
execute as @s[scores={cl.wand.slot1=505}] run function classes:mage/spells/earth/wall/select
