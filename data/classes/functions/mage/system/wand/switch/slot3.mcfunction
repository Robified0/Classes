...
execute as @s[scores={cl.wand.slot3=203}] run function classes:mage/spells/fire/fireball/select
...
execute as @s[scores={cl.wand.slot3=404}] run function classes:mage/spells/air/wind/select
