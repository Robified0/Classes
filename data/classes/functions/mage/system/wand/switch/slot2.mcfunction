...
execute as @s[scores={cl.wand.slot2=203}] run function classes:mage/spells/fire/fireball/select
...
execute as @s[scores={cl.wand.slot2=404}] run function classes:mage/spells/air/wind/select
...
execute as @s[scores={cl.wand.slot2=505}] run function classes:mage/spells/earth/wall/select
