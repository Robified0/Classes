...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",tag:{Torch:1b}}},advancements={classes:mage/learntorch=false}] run function classes:mage/system/learnspell/torch
