# Magic Spells
execute if entity @s[predicate=classes:checkspell/mage/magic/light] at @s run function classes:mage/spells/magic/light/spell
execute if entity @s[predicate=classes:checkspell/mage/magic/teleport] at @s run function classes:mage/spells/magic/teleport/spell
