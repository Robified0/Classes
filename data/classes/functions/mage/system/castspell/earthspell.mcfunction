# Earth Spells
execute if entity @s[scores={cl.spell.selected=500}] run function classes:mage/spells/earth/poison/cast
execute if entity @s[scores={cl.spell.selected=501}] run function classes:mage/spells/earth/ironflesh/cast
