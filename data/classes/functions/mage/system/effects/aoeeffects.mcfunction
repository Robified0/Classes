...
execute if entity @s[tag=cl.damage1] run effect give @e[type=!#classes:undead,type=!#classes:nontarget,type=!#classes:fireproof,distance=..3,limit=1,sort=random,tag=!summoned,tag=!cl.Owned] minecraft:instant_damage 1 0 true
execute if entity @s[tag=cl.damage1] run effect give @e[type=#classes:undead,type=!#classes:fireproof,distance=..3,limit=1,sort=random,tag=!summoned,tag=!cl.Owned] minecraft:instant_health 1 0 true
