...
execute if entity @s[scores={cl.e.IceWalker=0..}] run function classes:mage/effects/icewalker

#Blizzard
execute if entity @s[scores={cl.e.Blizzard=0..}] run function classes:mage/effects/blizzard

#Fire Shield - (tag=FireShield)
execute if entity @s[scores={cl.e.FireShield=0..}] run function classes:mage/effects/fireshield

#Slow Fall - (tag=SlowFall)
execute if entity @s[scores={cl.e.SlowFall=0..}] run function classes:mage/effects/slowfall

#Tail Wind - (tag=TailWind)
execute if entity @s[scores={cl.e.TailWind=0..}] run function classes:mage/effects/tailwind

#Tail Wind - (tag=BunnyHop)
execute if entity @s[scores={cl.e.BunnyHop=0..}] run function classes:mage/effects/bunnyhop

#Mage Armor - (tag=MageArmor)
execute if entity @s[scores={cl.e.MageArmor=0..}] run function classes:mage/effects/magearmor

#Iron Flesh - (tag=IronFlesh)
execute if entity @s[scores={cl.e.IronFlesh=0..}] run function classes:mage/effects/ironflesh

#Gold Flesh - (tag=GoldFlesh)
execute if entity @s[scores={cl.e.GoldFlesh=0..}] run function classes:mage/effects/goldflesh

#Diamond Flesh - (tag=DiaFlesh)
execute if entity @s[scores={cl.e.DiaFlesh=0..}] run function classes:mage/effects/diamondflesh

#Deep Freeze - (tag=DeepFreeze)
execute if entity @e[type=!#classes:nontarget,scores={cl.e.DeepFreeze=0..}] as @e[type=!#classes:nontarget,scores={cl.e.DeepFreeze=0..}] run function classes:mage/effects/deepfreeze

#Shield Spell
execute if entity @s[scores={cl.e.Shield=0..}] run function classes:mage/effects/shield
