...
#Learn Spell
execute if entity @a[scores={cl.track.sneak=0,cl.rightClick=1..}] as @a[predicate=classes:items/scrolls/learnspell,predicate=classes:check/mage/scroll] run function classes:mage/system/learnspell/main
