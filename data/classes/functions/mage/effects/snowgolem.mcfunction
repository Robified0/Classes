...
execute as @e[type=snow_golem,tag=summoned,scores={cl.summonCount=..0}] at @s run playsound minecraft:entity.enderman.teleport player @a ~ ~ ~ 0.5 1
execute as @e[type=snow_golem,tag=summoned,scores={cl.summonCount=..0}] run tp @s ~ -4096 ~
