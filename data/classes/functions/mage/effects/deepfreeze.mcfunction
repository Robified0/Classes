...
execute if entity @s[scores={cl.e.DeepFreeze=1..},tag=!cl.track.Invulnerable] run tag @s add cl.track.Invulnerable
...
execute if entity @s[scores={cl.e.DeepFreeze=..0}] run tag @s remove cl.track.Invulnerable 
