...
execute as @e[type=marker,tag=slowcast,tag=new,tag=waterstrike,limit=1] run function classes:mage/spells/waterstrike/zprivate/setup
tag @s remove this
...
tellraw @a[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" casted","color":"green"},{"text":" Water Strike!","bold":true,"color":"#0096FF"}]
