...
execute as @e[dx=0,tag=!this,type=!#classes:fireproof,type=!#classes:undead,type=!#classes:nontarget,type=!#classes:waterproof,type=!enderman,tag=!summoned,tag=!cl.Owned] positioned ~-0.79 ~-0.79 ~-0.79 if entity @s[dx=1] positioned ~0.79 ~0.79 ~0.79 run effect give @s instant_damage 1 1 true
...
execute as @e[dx=0,tag=!this,type=#classes:fireproof,type=!#classes:undead,type=!#classes:nontarget,type=!#classes:waterproof,tag=!summoned,tag=!cl.Owned] positioned ~-0.79 ~-0.79 ~-0.79 if entity @s[dx=1] positioned ~0.79 ~0.79 ~0.79 run effect give @s instant_damage 1 2 true
