...
execute if score #cl.pref cl.p.wExtFire matches 1 positioned ^ ^ ^0.5 if block ~ ~ ~ #minecraft:fire run playsound minecraft:block.fire.extinguish ambient @a[distance=..10] ~ ~ ~ 0.4 1
