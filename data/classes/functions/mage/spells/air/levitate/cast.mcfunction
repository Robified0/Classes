...
#Cast on self
execute if entity @s[scores={cl.Mana=4..},x_rotation=87..90,advancements={classes:mage/learnspell/air/levitate=true}] run function classes:mage/spells/air/levitate/effects/self

#Raycast
execute if entity @s[scores={cl.Mana=4..},advancements={classes:mage/learnspell/air/levitate=true}] unless entity @s[x_rotation=87..90] run function classes:mage/spells/air/levitate/zprivate/setparams
