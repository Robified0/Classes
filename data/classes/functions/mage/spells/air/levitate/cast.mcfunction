...
#Raycast
execute if entity @s[scores={cl.Mana=2..},advancements={classes:mage/learnspell/air/levitate=true}] unless entity @s[x_rotation=87..90] run function classes:mage/spells/air/levitate/zprivate/setparams

#Punish for casting without knowing the spell
execute if entity @s[scores={cl.Mana=2..},advancements={classes:mage/learnspell/air/levitate=false}] run function classes:main/mana_system/mage/noknowledge
