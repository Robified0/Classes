...
execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[tag=!cl.r.this,type=!#classes:nonmob,tag=!cl.t.summoned,tag=!cl.t.Owned,dx=0,dy=0,dz=0] at @s run function classes:mage/spells/air/levitate/effects/mob
