...
execute as @s[scores={Mana=3..}] run scoreboard players set @s cl.e.TailWind 400
...
#Playsound Effect
execute at @s[scores={Mana=3..}] run playsound minecraft:entity.horse.breathe player @a ~ ~ ~ 0.5 1

#Cast Spell Sound Effect
execute if entity @s[scores={Mana=3..}] at @s run function classes:mage/spells/all/cast
...
#Cooldown
execute as @s[scores={Mana=3..}] run scoreboard players set @s cl.Cooldown 20

#Mana Removal
execute as @s[scores={Mana=3..}] run scoreboard players remove @s cl.Mana 3
