...
execute if entity @s[scores={cl.Mana=1..,cl.e.Blizzard=6}] at @s as @e[type=!#classes:nontarget,type=!player,tag=!summoned,tag=!cl.Owned,distance=..10] at @s if block ^ ^1 ^-1 #classes:air run tp @s ^ ^0.5 ^-0.5
