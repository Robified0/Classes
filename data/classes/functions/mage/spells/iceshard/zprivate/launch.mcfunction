...
execute if score @s slo_dst matches 1.. run function classes:mage/spells/iceshard/raycast
scoreboard players operation @s slo_dst -= @s slo_dst_per
execute if score @s slo_dst matches ..0 at @s run function classes:mage/spells/iceshard/zprivate/end
