...
summon minecraft:marker ~ ~ ~ {Age:-2147483648,Duration:-1,WaitTime:-2147483648,Tags:["cl.new","cl.slowcast", "cl.teleport"]}
execute as @e[type=marker,tag=cl.slowcast,tag=cl.new,tag=cl.teleport,limit=1] run function classes:mage/spells/magic/teleport/zprivate/setup
...
tag @s add cl.Teleport

#Spell Cast Notification
tellraw @a[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" cast","color":"green"},{"text":" Teleport!","bold":true,"color":"light_purple"}]
