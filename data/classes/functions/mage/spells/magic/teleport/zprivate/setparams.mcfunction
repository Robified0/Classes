...
scoreboard players set #dst_per cl.slowcast 1
# how many half blocks to travel (24*0.5) = 12 blocks
scoreboard players set #dst cl.slowcast 100

#Start raycast
execute positioned ~ ~1.45 ~ run function classes:mage/spells/magic/teleport/start
