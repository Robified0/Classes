...
execute if entity @s[scores={cl.Mana=1..},advancements={classes:mage/learnspell/magic/magicmissile=true}] run function classes:mage/spells/magic/magicmissile/zprivate/setparams
