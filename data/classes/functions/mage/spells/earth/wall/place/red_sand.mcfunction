...
summon armor_stand ~ ~1.01 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:red_sand"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall"]}]}
summon armor_stand ~ ~1 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row2"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:red_sand"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall"]}]}
summon armor_stand ~ ~1 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row3"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:red_sand"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall"]}]}
