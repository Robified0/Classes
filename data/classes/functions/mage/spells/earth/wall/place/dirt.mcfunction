...
summon slime ~ ~1 ~ {ActiveEffects:[{Id:14,Amplifier:0b,Duration:1000,ShowParticles:0b}],HasVisualFire:0b,Silent:1b,Invulnerable:1b,NoAI:1b,CanPickUpLoot:0b,Size:2,Tags:["cl.earthWall.noScore","cl.t.summoned","cl.spell.noPassthrough"]}
summon slime ~ ~1 ~ {ActiveEffects:[{Id:14,Amplifier:0b,Duration:1000,ShowParticles:0b}],HasVisualFire:0b,Silent:1b,Invulnerable:1b,NoAI:1b,CanPickUpLoot:0b,Size:2,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row2","cl.t.summoned","cl.spell.noPassthrough"]}
summon slime ~ ~1 ~ {ActiveEffects:[{Id:14,Amplifier:0b,Duration:1000,ShowParticles:0b}],HasVisualFire:0b,Silent:1b,Invulnerable:1b,NoAI:1b,CanPickUpLoot:0b,Size:2,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row3","cl.t.summoned","cl.spell.noPassthrough"]}
...
summon armor_stand ~ ~1.01 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore","cl.t.summoned","cl.spell.noPassthrough"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:dirt"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall","cl.t.summoned","cl.spell.noPassthrough"]}]}
summon armor_stand ~ ~1 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row2","cl.t.summoned","cl.spell.noPassthrough"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:dirt"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall","cl.t.summoned","cl.spell.noPassthrough"]}]}
summon armor_stand ~ ~1 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row3","cl.t.summoned","cl.spell.noPassthrough"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:dirt"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall","cl.t.summoned","cl.spell.noPassthrough"]}]}
