...
summon slime ~ ~1 ~ {ActiveEffects:[{Id:14,Amplifier:0b,Duration:1000,ShowParticles:0b}],HasVisualFire:0b,Silent:1b,Invulnerable:1b,NoAI:1b,CanPickUpLoot:0b,Size:2,Tags:["cl.earthWall.noScore"]}
summon slime ~ ~1 ~ {ActiveEffects:[{Id:14,Amplifier:0b,Duration:1000,ShowParticles:0b}],HasVisualFire:0b,Silent:1b,Invulnerable:1b,NoAI:1b,CanPickUpLoot:0b,Size:2,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row2"]}
summon slime ~ ~1 ~ {ActiveEffects:[{Id:14,Amplifier:0b,Duration:1000,ShowParticles:0b}],HasVisualFire:0b,Silent:1b,Invulnerable:1b,NoAI:1b,CanPickUpLoot:0b,Size:2,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row3"]}
...
#Particle Effect
#particle end_rod ~ ~ ~ 1 1 1 0.1 100 force

#Summon armor stands. Stands are needed as falling_block is invisible when being TPed up manually.
summon armor_stand ~ ~1.01 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:dirt"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall"]}]}
summon armor_stand ~ ~1 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row2"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:dirt"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall"]}]}
summon armor_stand ~ ~1 ~ {Invulnerable:1b,ShowArms:0b,Small:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["cl.earthWall.noScore","cl.spell.earthWall.row3"],Passengers:[{id:"minecraft:falling_block",BlockState:{Name:"minecraft:dirt"},Invulnerable:1b,NoGravity:1b,Time:300,DropItem:0b,Motion:[0.0,0.1,0.0],Tags:["cl.spell.earthWall"]}]}
