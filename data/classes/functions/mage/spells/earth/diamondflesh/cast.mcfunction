...
execute if entity @s[scores={cl.Mana=6..},advancements={classes:mage/learnspell/earth/diamondflesh=true}] run function classes:mage/spells/earth/diamondflesh/spell
