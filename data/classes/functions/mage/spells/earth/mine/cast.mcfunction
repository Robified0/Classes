...
#Raycast
execute if entity @s[scores={cl.Mana=1..},advancements={classes:mage/learnspell/earth/mine=true}] run function classes:mage/spells/earth/mine/zprivate/setparams
