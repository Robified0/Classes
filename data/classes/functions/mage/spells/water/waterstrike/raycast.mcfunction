...
execute positioned ~ ~-0.5 ~ as @e[distance=..1.3,tag=!this,type=#classes:fireproof,type=#classes:undead,type=!#classes:nontarget,tag=!summoned,tag=!cl.Owned] positioned ~-0.25 ~-0.25 ~-0.25 if entity @s[dx=1] positioned ~0.25 ~0.25 ~0.25 run effect give @s instant_health 1 1 true
