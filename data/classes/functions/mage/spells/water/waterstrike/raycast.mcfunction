...
execute positioned ~ ~-0.5 ~ as @e[distance=..1.3,tag=!cl.r.this,type=!#classes:nontarget,type=!#classes:waterproof,tag=!cl.t.summoned,tag=!cl.t.Owned] at @s run function classes:mage/spells/water/waterstrike/effects/mob
execute positioned ~ ~-0.5 ~ as @e[distance=..1.3,tag=!cl.r.this,type=!#classes:nontarget,tag=cl.t.Owned] run data merge entity @s {Fire:1}
execute positioned ~ ~-0.5 ~ as @a[distance=..1.3,tag=!cl.r.this] run effect give @s fire_resistance 1 0 true
execute positioned ~ ~-0.5 ~ as @a[distance=..1.3,tag=!cl.r.this] run effect clear @s fire_resistance
