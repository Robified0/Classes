...
execute if entity @s[scores={cl.Mana=1..,cl.e.Blizzard=1..}] at @s run effect give @e[type=!#classes:nontarget,type=!player,tag=!cl.Owned,distance=..10] minecraft:wither 1 5
...
execute if entity @s[scores={cl.Mana=1..}] run scoreboard players remove @s[scores={cl.e.Blizzard.m=6}] cl.Mana 1
execute if entity @s[scores={cl.Mana=1..}] run scoreboard players set @s[scores={cl.e.Blizzard.m=6..}] cl.e.Blizzard.m 0
