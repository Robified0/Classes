...
execute if entity @s[scores={cl.Mana=4..}] at @s run tag @e[type=!#classes:bosses,type=!#classes:nontarget,distance=..5,tag=!summoned,tag=!cl.Owned,nbt=!{NoAI:1b}] add DeepFreeze
...
execute if entity @s[scores={cl.Mana=4..}] at @s as @e[type=!#classes:nontarget,predicate=classes:entities/angry,tag=DeepFreeze] at @s run function classes:entities/vanilla/angry
