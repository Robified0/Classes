...
execute if entity @s[scores={cl.Mana=4..},advancements={classes:mage/learnspell/water/deepfreeze=true}] run function classes:mage/spells/water/deepfreeze/spell
