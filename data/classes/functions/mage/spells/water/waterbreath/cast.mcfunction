...
execute if entity @s[scores={cl.Mana=4..},advancements={classes:mage/learnspell/water/waterbreath=true}] run function classes:mage/spells/water/waterbreath/spell
