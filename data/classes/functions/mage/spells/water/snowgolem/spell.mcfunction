##Executing as player casting spell (mage/spells/water/snowgolem/cast)
...
tellraw @a[tag=cl.p.SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" cast","color":"green"},{"text":" Summon Snow Golem!","bold":true,"color":"#0096FF"}]
