#Particle Effect
particle cloud ^-0.5 ^ ^0.3 0.1 0.1 0.1 0 2 normal

#Play sound effect - use here when needing repeat
playsound minecraft:entity.horse.breathe ambient @a[distance=..10] ~ ~ ~ 0.2

#Do these things when spell hits
execute as @p[x_rotation=87..90,distance=..1] run effect give @s minecraft:levitation 1 10 false
execute as @p[x_rotation=87..90,distance=..1] run effect give @s minecraft:slow_falling 3 1 false
execute as @e[dx=0,tag=!this] positioned ~-0.7 ~-0.7 ~-0.7 if entity @s[dx=0] positioned ~0.7 ~0.7 ~0.7 run effect give @s minecraft:levitation 1 10 false
execute as @e[dx=0,tag=!this,type=player] positioned ~-0.7 ~-0.7 ~-0.7 if entity @s[dx=0] positioned ~0.7 ~0.7 ~0.7 run effect give @s minecraft:slow_falling 3 1 false
