...
execute if entity @s[scores={cl.Mana=1..}] run scoreboard players set @s cl.e.IronFlesh 0
execute if entity @s[scores={cl.Mana=1..}] run scoreboard players set @s cl.e.DiaFlesh 0
execute if entity @s[scores={cl.Mana=1..}] run tag @s remove IronFlesh
execute if entity @s[scores={cl.Mana=1..}] run tag @s remove DiaFlesh

#Give Player Tag for particle effect
execute if entity @s[scores={cl.Mana=1..}] run tag @s add StoneFlesh
execute if entity @s[scores={cl.Mana=1..}] run scoreboard players set @s cl.e.StoneFlesh 3600

#Change base attribute
execute if entity @s[scores={cl.Mana=1..}] run attribute @s minecraft:generic.armor base set 4

#Particle effect
execute if entity @s[scores={cl.Mana=1..}] at @s run particle block stone ~ ~ ~ 1 1 1 10 40 normal
...
execute if entity @s[scores={cl.Mana=1..}] run tellraw @s[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" casted","color":"green"},{"text":" Stone Flesh!","bold":true,"color":"#AAAAAA"}]
