...
#Playsound Effect
execute at @s[scores={Mana=2..}] run playsound minecraft:block.beacon.power_select player @a[distance=..10] ~ ~ ~ 0.2 1.5
execute at @s[scores={Mana=2..}] run playsound minecraft:entity.zombie_villager.cure player @a[distance=..10] ~ ~ ~ 0.5 1.5
