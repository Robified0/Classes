#Particle Effect
particle flame ^-0.5 ^ ^0.3 0.3 0.3 0.3 0.05 6 force
...
execute as @e[dx=0,tag=!this,type=!#classes:nontarget,distance=..5] positioned ~-0.79 ~-0.79 ~-0.79 if entity @s[dx=0] positioned ~0.79 ~0.79 ~0.79 at @s run particle minecraft:small_flame ~ ~ ~ 0.5 0.5 0.5 0.5 50 normal
...
execute if score #temp slowcast matches 0.. positioned ^ ^ ^0.5 if block ~ ~ ~ #classes:air run function classes:mage/spells/fireball/raycast
execute if score #temp slowcast matches 0.. positioned ^ ^ ^0.5 if block ~ ~ ~ obsidian if block ^ ^ ^-1 air run setblock ^ ^ ^-1 minecraft:fire
...
execute if score #temp slowcast matches 0.. positioned ^ ^ ^0.5 unless block ~ ~ ~ #classes:air run function classes:mage/spells/fireball/zprivate/end
