...
execute if entity @s[scores={cl.Mana=8..}] at @s run playsound minecraft:entity.evoker.prepare_summon player @a ~ ~ ~ 0.1 2
execute if entity @s[scores={cl.Mana=8..}] at @s run playsound minecraft:entity.iron_golem.death player @a ~ ~ ~ 0.8 2

#Particles
execute if entity @s[scores={cl.Mana=8..}] at @s run particle minecraft:enchant ~ ~ ~ 1 1 1 1 40 normal
...
item modify entity @s weapon.mainhand classes:mage/spells/irongolem
