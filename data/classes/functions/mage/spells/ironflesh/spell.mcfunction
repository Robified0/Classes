...
execute if entity @s[scores={cl.Mana=2..}] run scoreboard players set @s cl.e.StoneFlesh 0
execute if entity @s[scores={cl.Mana=2..}] run scoreboard players set @s cl.e.DiaFlesh 0
execute if entity @s[scores={cl.Mana=2..}] run tag @s remove StoneFlesh
execute if entity @s[scores={cl.Mana=2..}] run tag @s remove DiaFlesh

#Give Player Tag for particle effect
execute if entity @s[scores={cl.Mana=2..}] run tag @s add IronFlesh
execute if entity @s[scores={cl.Mana=2..}] run scoreboard players set @s cl.e.IronFlesh 3600

#Change base attribute
execute if entity @s[scores={cl.Mana=2..}] run attribute @s minecraft:generic.armor base set 8

#Particle effect
execute if entity @s[scores={cl.Mana=2..}] at @s run particle block iron_block ~ ~ ~ 1 1 1 10 40 normal
...
execute if entity @s[scores={cl.Mana=2..}] run tellraw @s[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" casted","color":"green"},{"text":" Iron Flesh!","bold":true,"color":"#AAAAAA"}]
