...
execute as @s[scores={cl.Mana=5..}] at @s run tag @e[type=!#classes:bosses,type=!#classes:nontarget,distance=..3,tag=!summoned,nbt=!{NoAI:1b}] add DeepFreeze
...
execute as @s[scores={cl.Mana=5..}] at @s as @e[type=!#classes:nontarget,distance=..3,nbt={AngerTime:0},tag=!summoned] run data modify entity @s AngryAt set from entity @p[tag=GetAngry] UUID
execute as @s[scores={cl.Mana=5..}] at @s as @e[type=#classes:neutral,nbt=!{Brain:{memories:{"minecraft:angry_at":{}}}},tag=!summoned] run data modify entity @s Brain.memories."minecraft:angry_at".value set from entity @p[tag=GetAngry] UUID
tag @s remove GetAngry

#Sound effect
execute as @s[scores={cl.Mana=5..}] at @e[tag=DeepFreeze,distance=..3] run playsound minecraft:block.fire.extinguish player @a ~ ~ ~ 0.8 2
execute as @s[scores={cl.Mana=5..}] at @e[tag=DeepFreeze,distance=..3] run playsound minecraft:block.amethyst_block.chime player @a ~ ~ ~ 5 1.5
execute as @s[scores={cl.Mana=5..}] at @s unless entity @e[tag=DeepFreeze,distance=..3] run playsound minecraft:entity.blaze.shoot player @s ~ ~ ~ 0.5 2
...
#Mana Removal
execute as @s[scores={cl.Mana=5..}] if entity @e[tag=DeepFreeze,distance=..3] run scoreboard players remove @s cl.Mana 5
