...
execute if entity @s[type=dolphin] run data merge entity @s {DeathLootTable:"classes:entities/dolphin"}
execute if entity @s[type=donkey] run data merge entity @s {DeathLootTable:"classes:entities/donkey"}
execute if entity @s[type=fox] run data merge entity @s {DeathLootTable:"classes:entities/fox"}
execute if entity @s[type=#classes:119/frog] run data merge entity @s {DeathLootTable:"classes:entities/frog"}
