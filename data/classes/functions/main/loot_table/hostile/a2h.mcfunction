...
execute if entity @s[type=elder_guardian] run data merge entity @s {DeathLootTable:"classes:entities/elder_guardian"}
execute if entity @s[type=enderman] run data merge entity @s {DeathLootTable:"classes:entities/enderman"}
execute if entity @s[type=endermite] run data merge entity @s {DeathLootTable:"classes:entities/endermite"}
execute if entity @s[type=drowned] run data merge entity @s {DeathLootTable:"classes:entities/evoker"}
