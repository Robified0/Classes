...
execute as @p[advancements={classes:mage/learnspell/water/extinguish=true},scores={cl.Class=3}] run function classes:main/essences/mage/water/extinguish/known
