...
execute as @p[advancements={classes:mage/learnspell/earth/irongolem=true},scores={cl.Class=3}] run function classes:main/essences/mage/earth/irongolem/known
