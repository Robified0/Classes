...
execute if entity @s[scores={cl.track.Soul.time=8..}] run data merge entity @s {Item:{tag:{CustomModelData:104,cl.SoulEarth:1b,display:{Name:'{"text":"Earth Soul","color":"green","italic":true}'}}}}
