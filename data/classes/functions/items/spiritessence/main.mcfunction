...
# Air
execute if entity @s[predicate=classes:items/spiritessence/ycheck,scores={cl.item.spiritessence=3..}] if block ~ ~ ~ #classes:airtypes run function classes:items/spiritessence/air
