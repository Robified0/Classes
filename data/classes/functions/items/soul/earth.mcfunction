...
execute if entity @s[scores={cl.track.Soul.time=8..}] run data merge entity @s {Item:{tag:{HideFlags:127,CustomModelData:105,cl.isSoul:1b,cl.SoulEarth:1b,Enchantments:[{}],display:{Name:'{"translate":"item.classes.soul.earth","color":"dark_green","italic":true}'}}}}
