...
#Healing Spells
execute if entity @s[scores={cl.spell.selected=700..799},predicate=!classes:items/books/book,predicate=!classes:items/books/spellbook,predicate=!classes:items/spiritessence/spiritessence] run function classes:weapons/staff/castspell/healingspell

#Buff Spells
execute if entity @s[scores={cl.spell.selected=800..899},predicate=!classes:items/books/book,predicate=!classes:items/books/spellbook,predicate=!classes:items/spiritessence/spiritessence] run function classes:weapons/staff/castspell/buffspell

#Smiting Spells
execute if entity @s[scores={cl.spell.selected=900..999},predicate=!classes:items/books/book,predicate=!classes:items/books/spellbook,predicate=!classes:items/spiritessence/spiritessence] run function classes:weapons/staff/castspell/smitingspell
