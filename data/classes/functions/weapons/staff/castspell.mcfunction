...
#Holy
execute if entity @s[scores={cl.spell.selected=700..799},predicate=!classes:items/books/book,predicate=!classes:items/books/spellbook,predicate=!classes:items/souls/soul] run function classes:weapons/staff/castspell/holyspell
