...
title @p[scores={cl.Class=4},distance=..2] subtitle {"text":"You learned about Rotten Flesh.","color":"gold"}
title @p[scores={cl.Class=4},distance=..2] title {"text":""}

# Handle the scoreboard.
scoreboard players set @p[scores={cl.Class=4},distance=..2] cl.item.research.rotten_flesh 1
