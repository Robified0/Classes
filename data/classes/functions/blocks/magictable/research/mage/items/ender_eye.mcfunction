...
title @p[scores={cl.Class=3},distance=..2] subtitle {"text":"You learned about Ender Eye.","color":"gold"}
title @p[scores={cl.Class=3},distance=..2] title {"text":""}

# Handle the scoreboard.
scoreboard players set @p[scores={cl.Class=3},distance=..2] cl.item.research.ender_eye 1
