...
title @p[scores={cl.Class=3},distance=..2] subtitle {"text":"You learned about Earth Essence.","color":"gold"}
title @p[scores={cl.Class=3},distance=..2] title {"text":""}

# Handle the scoreboard.
scoreboard players set @p[scores={cl.Class=3},distance=..2] cl.item.research.earth_essence 1

#Give advancement
advancement grant @p[scores={cl.Class=3},distance=..2] only classes:mage/essence/researchearthessence
