...
#Upgrade Staff
execute if block ~ ~ ~ barrel{Items:[{id:"minecraft:warped_fungus_on_a_stick",tag:{cl.isStaff:1b}},{id:"minecraft:structure_block",tag:{cl.Soul:1b}},{id:"minecraft:lapis_block"}]} run function classes:blocks/magictable/recipes/items/staffs/upgrade/staff
