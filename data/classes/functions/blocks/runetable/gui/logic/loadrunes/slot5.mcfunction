...
#Reset first lore
execute if block ~ ~ ~ barrel{Items:[{Slot:16b,tag:{CustomModelData:201}}]} run data modify block ~ ~ ~ Items[{Slot:16b}].tag.display.Name set value '{"text":"Magic Rune","color":"light_purple"}'
execute if block ~ ~ ~ barrel{Items:[{Slot:16b,tag:{CustomModelData:202}}]} run data modify block ~ ~ ~ Items[{Slot:16b}].tag.display.Name set value '{"text":"Fire Rune","color":"red"}'
execute if block ~ ~ ~ barrel{Items:[{Slot:16b,tag:{CustomModelData:203}}]} run data modify block ~ ~ ~ Items[{Slot:16b}].tag.display.Name set value '{"text":"Water Rune","color":"blue"}'
