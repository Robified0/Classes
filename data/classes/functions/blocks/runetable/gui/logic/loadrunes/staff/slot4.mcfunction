...
data modify block ~ ~ ~ Items[{Slot:15b}].tag.display.Lore insert 1 from block ~ ~ ~ Items[{Slot:10b}].tag.display.Lore[13]
data modify block ~ ~ ~ Items[{Slot:15b}].tag.display.Lore insert 2 from block ~ ~ ~ Items[{Slot:10b}].tag.display.Lore[14]
