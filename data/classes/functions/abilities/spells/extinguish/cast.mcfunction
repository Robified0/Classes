...
execute if entity @s[scores={cl.Mana=2..},advancements={classes:mage/learnspell/water/extinguish=true}] run function classes:abilities/spells/extinguish/spell
