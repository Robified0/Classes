##Executing as player casting spell (abilities/spells/deepfreeze/cast)
...
execute as @e[type=marker,tag=cl.r.slowcast,tag=cl.r.new,tag=cl.r.deepfreeze,limit=1] run function classes:abilities/spells/deepfreeze/zprivate/setup
