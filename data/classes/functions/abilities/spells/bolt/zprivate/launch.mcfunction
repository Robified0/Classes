...
execute if score @s cl.slo_dst matches 1.. run function classes:abilities/spells/bolt/raycast
scoreboard players operation @s cl.slo_dst -= @s cl.slo_dst_per
execute if score @s cl.slo_dst matches ..0 at @s run function classes:abilities/spells/bolt/zprivate/end
