...
execute if entity @s[scores={cl.Mana=2..},advancements={classes:mage/learnspell/water/waterstrike=true}] run function classes:abilities/spells/waterstrike/zprivate/setparams
