...
execute if entity @s[scores={cl.e.DiaFlesh=..0}] run tellraw @s ["",{"text":"\u2734 ","color":"light_purple"},{"translate":"spell.classes.503.name","italic":true,"color":"white"},{"translate":"chat.classes.spell.ended","italic":true,"color":"white"}]
