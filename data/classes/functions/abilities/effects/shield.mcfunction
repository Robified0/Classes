...
execute if entity @s[scores={cl.e.Shield=1..}] anchored eyes positioned ^ ^ ^2.1 as @e[type=#classes:projectiles,distance=..2] run function classes:abilities/effects/shielddeflect
