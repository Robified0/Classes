...
execute if entity @s[scores={cl.e.GoldFlesh=..0}] run tellraw @s ["",{"text":"\u2734 ","color":"light_purple"},{"translate":"spell.classes.502.name","italic":true,"color":"white"},{"translate":"chat.classes.spell.ended","italic":true,"color":"white"}]
