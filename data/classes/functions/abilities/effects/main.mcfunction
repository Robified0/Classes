...
execute if entity @s[scores={cl.e.IceWalker=0..}] run function classes:abilities/effects/icewalker

#Blizzard
execute if entity @s[scores={cl.e.Blizzard=0..}] run function classes:abilities/effects/blizzard

#Fire Shield - (tag=FireShield)
execute if entity @s[scores={cl.e.FireShield=0..}] run function classes:abilities/effects/fireshield/main
...
execute if entity @s[scores={cl.e.SlowFall=0..}] run function classes:abilities/effects/slowfall

#Tail Wind - (tag=TailWind)
execute if entity @s[scores={cl.e.TailWind=0..}] run function classes:abilities/effects/tailwind

#Tail Wind - (tag=BunnyHop)
execute if entity @s[scores={cl.e.BunnyHop=0..}] run function classes:abilities/effects/bunnyhop

#Mage Armor - (tag=MageArmor)
execute if entity @s[scores={cl.e.MageArmor=0..}] run function classes:abilities/effects/magearmor

#Iron Flesh - (tag=IronFlesh)
execute if entity @s[scores={cl.e.IronFlesh=0..}] run function classes:abilities/effects/ironflesh

#Gold Flesh - (tag=GoldFlesh)
execute if entity @s[scores={cl.e.GoldFlesh=0..}] run function classes:abilities/effects/goldflesh

#Diamond Flesh - (tag=DiaFlesh)
execute if entity @s[scores={cl.e.DiaFlesh=0..}] run function classes:abilities/effects/diamondflesh
...
#Shield Spell
execute if entity @s[scores={cl.e.Shield=0..}] run function classes:abilities/effects/shield
