...
execute as @a[tag=!Joined] run scoreboard players set @s currentSpellSel 1
execute as @a[tag=!Joined] run scoreboard players set @s loadOrder 1
...
execute as @a[scores={Sneaking=1..,rightClick=1..,class=3,currentSpellSel=5}] run function classes:mage/wand/basewand/switch/slot1
...
execute as @a[scores={Sneaking=1..,rightClick=1..,class=3,currentSpellSel=4}] run function classes:mage/wand/basewand/switch/slot5
execute as @a[scores={Sneaking=1..,rightClick=1..,class=3,currentSpellSel=1..5}] run scoreboard players add @s currentSpellSel 1
execute as @a[scores={Sneaking=1..,rightClick=1..,class=3,currentSpellSel=6}] run scoreboard players set @s currentSpellSel 1
...
execute as @a[scores={Sneaking=1..,rightClick=1..,class=4,currentSpellSel=5}] run function classes:healer/wand/basewand/switch/slot1
...
execute as @a[scores={Sneaking=1..,rightClick=1..,class=4,currentSpellSel=4}] run function classes:healer/wand/basewand/switch/slot5
execute as @a[scores={Sneaking=1..,rightClick=1..,class=4,currentSpellSel=1..5}] run scoreboard players add @s currentSpellSel 1
execute as @a[scores={Sneaking=1..,rightClick=1..,class=4,currentSpellSel=6}] run scoreboard players set @s currentSpellSel 1
execute as @a[scores={Sneaking=1..,rightClick=1..,class=4,currentSpellSel=0}] run scoreboard players set @s currentSpellSel 1
...
execute as @a[scores={equipSpell=1..,loadSpell=0..5}] run function classes:equip

#Handle max spells, and messaging.
execute as @a[scores={equipSpell=1..,loadSpell=6}] run tellraw @s {"text":"You're maxed out. Clear your wand to equip other spells."}
execute as @a[scores={equipSpell=1..,loadSpell=6}] run scoreboard players set @s equipSpell 0
...
scoreboard players add @a[scores={ManaRegenSec=..59,Mana=..9}] ManaRegenSec 1
