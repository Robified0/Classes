...
function classes:healer/system/wand/switch/emptyslot
execute if entity @s[scores={cl.slot.selected=6}] run scoreboard players set @s cl.slot.selected 1
execute if entity @s[scores={cl.slot.selected=1}] run function classes:healer/system/wand/switch/slot1
execute if entity @s[scores={cl.slot.selected=2}] run function classes:healer/system/wand/switch/slot2
execute if entity @s[scores={cl.slot.selected=3}] run function classes:healer/system/wand/switch/slot3
execute if entity @s[scores={cl.slot.selected=4}] run function classes:healer/system/wand/switch/slot4
execute if entity @s[scores={cl.slot.selected=5}] run function classes:healer/system/wand/switch/slot5
