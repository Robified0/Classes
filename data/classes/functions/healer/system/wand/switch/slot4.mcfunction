...
execute as @s[scores={cl.s.StopUndead=4},nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{Wand:1b}}}] run function classes:healer/spells/stopundead/select
