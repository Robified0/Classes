...
execute if entity @s[advancements={classes:healer/learnspell/buff/fireresist=false}] run item replace entity @s inventory.1 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/buff/fireresist] run item replace entity @s inventory.1 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/buff/guard=false}] run item replace entity @s inventory.2 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/buff/guard] run item replace entity @s inventory.2 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/buff/inspire=false}] run item replace entity @s inventory.3 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/buff/inspire] run item replace entity @s inventory.3 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/buff/speedboost=false}] run item replace entity @s inventory.4 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/buff/speedboost] run item replace entity @s inventory.4 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/buff/vitality=false}] run item replace entity @s inventory.5 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/buff/vitality] run item replace entity @s inventory.5 with minecraft:air
