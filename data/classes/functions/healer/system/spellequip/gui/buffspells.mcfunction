...
execute if entity @s[advancements={classes:healer/learnspell/buff/bless=false}] run item replace entity @s inventory.0 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/buff/fireresist=false}] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/buff/guard=false}] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/buff/inspire=false}] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/buff/speedboost=false}] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/buff/vitality=false}] run item replace entity @s inventory.5 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
