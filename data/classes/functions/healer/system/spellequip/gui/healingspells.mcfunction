...
execute if entity @s[advancements={classes:healer/learnspell/healing/heal=false}] run item replace entity @s inventory.0 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/heal] run item replace entity @s inventory.0 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/healing/cureeffects=false}] run item replace entity @s inventory.1 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/cureeffects] run item replace entity @s inventory.1 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/healing/healcircle=false}] run item replace entity @s inventory.2 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/healcircle] run item replace entity @s inventory.2 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/healing/mending=false}] run item replace entity @s inventory.3 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/mending] run item replace entity @s inventory.3 with minecraft:air
...
execute if entity @s[advancements={classes:healer/learnspell/healing/satiate=false}] run item replace entity @s inventory.4 with minecraft:air
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/satiate] run item replace entity @s inventory.4 with minecraft:air
