...
#Cure Effects
item replace entity @s[advancements={classes:healer/learnspell/healing/cureeffects=true}] inventory.1 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Cure Effects","color":"green"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 3","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Buffs all players within 5 blocks. Cures all effects (except fire) for 30 seconds.","color":"green"}']},CustomModelData:60703,cl.s.Spell:1b,cl.s.Healing:1b,cl.s.CureEffects:1b,cl.spell.number:703}
execute if entity @s[advancements={classes:healer/learnspell/healing/cureeffects=false}] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/cureeffects] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/healing/healcircle=false}] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/healcircle] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/healing/mending=false}] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/mending] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
execute if entity @s[advancements={classes:healer/learnspell/healing/satiate=false}] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/satiate] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
