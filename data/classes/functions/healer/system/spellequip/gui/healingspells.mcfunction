...
#Purify
item replace entity @s[tag=cl.knowsSpell.Purify] inventory.1 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Purify","color":"green"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 1","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Cure all negative effects on target.","color":"green"}','{"text":" "}','[{"text":""},{"text":"Self Cast:"}]','{"text":"Cast while looking at the ground.","color":"green"}']},CustomModelData:60702,cl.s.Spell:1b,cl.s.Healing:1b,cl.s.Purify:1b,cl.spell.number:702}
execute if entity @s[tag=!cl.knowsSpell.Purify] run item replace entity @s inventory.1 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
#Healplosion
item replace entity @s[tag=cl.knowsSpell.Healplosion] inventory.3 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Healplosion","color":"green"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 3","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Target and surrounding mobs within 5 blocks are healed for 4 hearts","color":"green"}']},CustomModelData:60701,cl.s.Spell:1b,cl.s.Healing:1b,cl.s.Healplosion:1b,cl.spell.number:701}
execute if entity @s[tag=!cl.knowsSpell.Healplosion] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
execute if entity @s[predicate=classes:spellselect/hotbarcheck/healer/healing/healplosion] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}

#Mending
item replace entity @s[tag=cl.knowsSpell.Mending] inventory.4 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Mending","color":"green"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003/1 Sec","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Heals all allies within 10 blocks 2 Hearts/sec.","color":"green"}']},CustomModelData:60704,cl.s.Spell:1b,cl.s.Healing:1b,cl.s.Mending:1b,cl.spell.number:704}
execute if entity @s[tag=!cl.knowsSpell.Mending] run item replace entity @s inventory.4 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
