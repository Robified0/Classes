...
#Holy Strike
item replace entity @s[advancements={classes:healer/learnspell/smiting/holystrike=true}] inventory.2 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Holy Strike","color":"green"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 1","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Smites undead it hits. Can hit multiple in a line.","color":"green"}']},CustomModelData:60900,cl.s.Spell:1b,cl.s.Smiting:1b,cl.s.HolyStrike:1b,cl.spell.number:900}
execute if entity @s[advancements={classes:healer/learnspell/smiting/holystrike=false}] run item replace entity @s inventory.2 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
...
#Stop Undead
item replace entity @s[advancements={classes:healer/learnspell/smiting/stopundead=true}] inventory.3 with minecraft:warped_fungus_on_a_stick{display:{Name:'[{"text":"Stop Undead","color":"green"},{"text":" - ","color":"white","bold":false},{"text":"\\uE003 x 3","color":"aqua","bold":false,"italic":false}]',Lore:['{"text":"------------------","color":"dark_aqua"}','{"text":" "}','{"text":"Effect:"}','{"text":"Normal undead within 10 blocks freeze in place.","color":"green"}']},CustomModelData:60901,cl.s.Spell:1b,cl.s.Smiting:1b,cl.s.StopUndead:1b,cl.spell.number:901}
execute if entity @s[advancements={classes:healer/learnspell/smiting/stopundead=false}] run item replace entity @s inventory.3 with minecraft:black_stained_glass_pane{display:{Name:'{"text":""}'},cl.item.noDrop:1b}
