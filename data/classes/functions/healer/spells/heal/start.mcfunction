...
execute as @e[type=marker,tag=slowcast,tag=new,tag=heal,limit=1] run function classes:healer/spells/heal/zprivate/setup
tag @s remove this
...
tellraw @a[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" casted","color":"green"},{"text":" Heal!","bold":true,"color":"green"}]
