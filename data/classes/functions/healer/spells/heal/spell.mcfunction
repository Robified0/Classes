...
execute if entity @s[scores={cl.Mana=1..},x_rotation=87..90,distance=..1] run effect give @s minecraft:instant_health 2 0 true

#Play sound effect - use here when needing repeat
execute if entity @s[scores={cl.Mana=1..},x_rotation=87..90,distance=..1] at @s run playsound minecraft:block.amethyst_block.chime player @a ~ ~ ~ 2 1.5
#Particles
execute if entity @s[scores={cl.Mana=1..},x_rotation=87..90,distance=..1] at @s run particle minecraft:end_rod ~ ~ ~ 0.5 1 0.5 0.01 10 force
execute if entity @s[scores={cl.Mana=1..},x_rotation=87..90,distance=..1] at @s run particle minecraft:happy_villager ~ ~ ~ 0.5 1 0.5 0.08 50 force
#Mana Depletion
