...
execute unless entity @s[scores={cl.Mana=2..},x_rotation=87..90] positioned ~ ~1.45 ~ run function classes:healer/spells/heal/start

#If Player is looking at ground:
execute if entity @s[scores={cl.Mana=2..},x_rotation=87..90] run effect give @s minecraft:instant_health 2 0 true

#Play sound effect.
execute if entity @s[scores={cl.Mana=2..},x_rotation=87..90] at @s run playsound minecraft:block.amethyst_block.chime player @a ~ ~ ~ 2 1.5
