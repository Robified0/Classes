...
execute as @e[type=marker,tag=slowcast,tag=new,tag=holystrike,limit=1] run function classes:healer/spells/smiting/holystrike/zprivate/setup
tag @s remove this
...
tellraw @a[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" cast","color":"green"},{"text":" Holy Strike!","bold":true,"color":"green"}]
