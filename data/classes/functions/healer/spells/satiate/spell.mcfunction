...
execute unless entity @s[x_rotation=87..90] if entity @s[scores={cl.Mana=2..}] at @s positioned ~ ~1.45 ~ run function classes:healer/spells/satiate/start
...
item modify entity @s weapon.mainhand classes:healer/spells/satiate
