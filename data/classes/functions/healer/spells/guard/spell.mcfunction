...
execute as @s[scores={cl.Mana=5..}] at @s run summon marker ~ ~1 ~ {Tags:["Guard","summoned"]}
execute as @s[scores={cl.Mana=5..}] at @s run summon marker ~ ~1 ~ {Tags:["GuardSphere","sphere","ball2","summoned"]}
execute as @s[scores={cl.Mana=5..}] at @s run summon marker ~ ~1 ~ {Tags:["GuardSphere","sphere","ball1","summoned"]}
execute as @s[scores={cl.Mana=5..}] run scoreboard players set @s cl.summonCount 400
execute as @s[scores={cl.Mana=5..}] run scoreboard players set @e[type=marker,tag=Guard,limit=1,sort=nearest] cl.summonCount 400
execute as @s[scores={cl.Mana=5..}] run scoreboard players set @e[type=marker,tag=GuardSphere,limit=2,sort=nearest] cl.summonCount 400
...
execute as @s[scores={cl.Mana=5..}] run tellraw @a[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" casted","color":"green"},{"text":" Guard!","bold":true,"color":"green"}]
