...
execute if entity @s[scores={cl.Mana=4..},advancements={classes:healer/learnspell/healing/healcircle=true}] run function classes:healer/spells/healing/healcircle/spell
