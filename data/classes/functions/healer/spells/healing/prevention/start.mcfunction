...
execute as @e[type=marker,tag=cl.r.slowcast,tag=cl.r.new,tag=cl.r.prevention,limit=1] run function classes:healer/spells/healing/prevention/zprivate/setup
