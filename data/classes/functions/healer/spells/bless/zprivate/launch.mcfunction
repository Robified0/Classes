...
execute if score @s cl.slo_dst matches 1.. run function classes:healer/spells/bless/raycast
scoreboard players operation @s cl.slo_dst -= @s cl.slo_dst_per
execute if score @s cl.slo_dst matches ..0 at @s run function classes:healer/spells/bless/zprivate/end
