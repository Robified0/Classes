...
summon minecraft:marker ~ ~ ~ {Age:-2147483648,Duration:-1,WaitTime:-2147483648,Tags:["new","slowcast", "bless"]}
execute as @e[type=marker,tag=slowcast,tag=new,tag=bless,limit=1] run function classes:healer/spells/bless/zprivate/setup
tag @s remove this
