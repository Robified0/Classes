...
execute if entity @s[scores={cl.Mana=2..}] run tellraw @a[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" cast","color":"green"},{"text":" Speed Boost!","bold":true,"color":"green"}]
...
item modify entity @s weapon.mainhand classes:healer/spells/speedboost
