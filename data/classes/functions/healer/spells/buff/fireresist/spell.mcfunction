...
scoreboard players set @a[distance=..10,limit=5,sort=nearest] cl.e.FireResist 6000
execute as @a[scores={cl.e.FireResist=6000},distance=..10,limit=5,sort=nearest] run effect give @s minecraft:fire_resistance 300 0 false
