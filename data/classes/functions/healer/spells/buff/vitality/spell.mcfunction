...
execute unless entity @s[x_rotation=87..90] if entity @s[scores={cl.Mana=4..}] run scoreboard players set dst_per cl.slowcast 4
# how many half blocks to travel (24*0.5) = 12 blocks
execute unless entity @s[x_rotation=87..90] if entity @s[scores={cl.Mana=4..}] run scoreboard players set dst cl.slowcast 48

execute unless entity @s[x_rotation=87..90] if entity @s[scores={cl.Mana=4..}] at @s positioned ~ ~1.45 ~ run function classes:healer/spells/buff/vitality/start
...
#Particles
execute if entity @s[scores={cl.Mana=4..},x_rotation=87..90] at @s run particle minecraft:wax_off ~ ~ ~ 0.5 0.5 0.5 0.01 50 force
execute if entity @s[scores={cl.Mana=4..},x_rotation=87..90] at @s run particle minecraft:happy_villager ~ ~ ~ 0.5 0.5 0.5 0.08 50 force

#Add Cooldown
execute if entity @s[scores={cl.Mana=4..},x_rotation=87..90] run scoreboard players set @s cl.Cooldown 20

#Spell Cast Notification
execute if entity @s[scores={cl.Mana=4..}] run tellraw @a[tag=SpellNotify,distance=..40] ["",{"selector":"@s"},{"text":" cast","color":"green"},{"text":" Vitality!","bold":true,"color":"green"}]
